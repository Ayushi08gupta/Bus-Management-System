      ...
      <div className="relative z-10 max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="space-y-8">
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-3">
              <div className="flex items-center justify-center w-10 h-10 rounded-full bg-purple-400/30">
                <MapPin className="w-5 h-5 text-purple-600" />
              </div>
              <span className="text-gray-700 font-medium">Live GPS Tracking</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="flex items-center justify-center w-10 h-10 rounded-full bg-blue-400/30">
                <Clock className="w-5 h-5 text-blue-600" />
              </div>
              <span className="text-gray-700 font-medium">Accurate ETAs</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="flex items-center justify-center w-10 h-10 rounded-full bg-green-400/30">
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-4">
            <Button
              className="btn-glass btn-gradient text-base h-12 px-8 flex items-center justify-center gap-2"
        ...
        <div className="relative h-96 lg:h-full min-h-96 flex items-center justify-center">
          <div className="space-y-4 w-full max-w-sm">
            {/* Benefit Card 1 */}
            <div className="glass-card p-6 card-hover border-2 border-purple-300/50">
              <div className="flex gap-4">
                <div className="w-12 h-12 rounded-full bg-purple-400/40 flex items-center justify-center flex-shrink-0">
            ...
            {/* Benefit Card 2 */}
            <div className="glass-card p-6 card-hover border-2 border-blue-300/50">
              <div className="flex gap-4">
                <div className="w-12 h-12 rounded-full bg-blue-400/40 flex items-center justify-center flex-shrink-0">
            ...
            {/* Benefit Card 3 */}
            <div className="glass-card p-6 card-hover border-2 border-green-300/50">
              <div className="flex gap-4">
                <div className="w-12 h-12 rounded-full bg-green-400/40 flex items-center justify-center flex-shrink-0">
            ...
            {/* Benefit Card 4 */}
            <div className="glass-card p-6 card-hover border-2 border-pink-300/50">
              <div className="flex gap-4">
                <div className="w-12 h-12 rounded-full bg-pink-400/40 flex items-center justify-center flex-shrink-0">
